  ...
  return (
    <section ref={ref} className='bg-brown min-h-[100vh] w-full py-[10%]'>
      <motion.div
        ...
        className="py-2"
      >
        <div className='container flex-col w-full lg:justify-between overflow-y-hidden  lg:flex-row lg:items-center flex xl:items-start h-full justify-between gap-[5rem]'>
          <div className='left flex text-pryWhite h-full overflow-y-hidden flex-col gap-[2rem] w-full items-start lg:w-1/2'>
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }} // triggers when 20% in view
            className="right lg:w-1/2 w-full"
          >
            <Image
