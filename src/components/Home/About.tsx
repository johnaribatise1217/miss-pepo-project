...
const About = forwardRef<HTMLElement>((props, ref) => {
  return (
    <section ref={ref} className='bg-brown min-h-[100vh] w-full py-[8.5%]'>
      <div className='container md:flex-col lg:flex-row lg:items-center flex xl:items-start h-full justify-between gap-[5rem]'>
        <div className='left flex text-pryWhite flex-col gap-[2rem] md:w-full items-start w-1/2'>
          <p className='text-[clamp(28px,4vw,56px)] leading-[120%] bricolage-grotesque'>
