...
const LastSection = () => {
  ...
  return (
    <section className='bg-secBlack relative w-full min-h-[90vh] py-[8%] flex flex-col gap-[2rem]'>
        ...
        <div className='flex flex-col lg:flex-row w-full gap-[3rem] h-full items-start'>
          ...
          <div className="right w-full lg:w-1/2 h-full">
            <form onSubmit={handleSubmit} action="" className='w-full inter flex flex-col h-full gap-[1.5rem]'>
              ...
              <button type='submit' className='bg-pryPablo mb-[1rem] shadow-[0_6px_0_0_#5e5547] w-full lg:w-[20%] p-[20px] rounded-[16px] text-white cursor-pointer'>
                Send
              </button>
            </form>
          </div>
