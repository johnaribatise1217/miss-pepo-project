...
const Testimonial = () => {
  ...
  return (
    <section className='bg-secBlack relative w-full min-h-[100vh] py-[8.5%] flex flex-col gap-[2rem]'>
      ...
      p-[32px] 2xl:p-[40px] h-[500px] rounded-[35px]'>
        <div className='flex flex-col items-start w-1/2 gap-[2rem]'>
          ...
          <button onClick={handleTermsClick} className='bg-white inter px-6 py-4 border rounded-[16px] border-b-[5px]'>Book Me!</button>
        </div>
