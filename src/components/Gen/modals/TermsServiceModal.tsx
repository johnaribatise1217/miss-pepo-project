...
const TermsServiceModal = ({ isOpen, onClose, onAgree } : any) => {
  const [form, setForm] = useState({ name: "", signature: "", date: "" });
  ...
  return (
    <ModalBase isOpen={isOpen} onClose={onClose}>
      ...
      {/* Scrollable Body */}
      <div className="overflow-y-auto max-h-[450px] 2xl:max-h-[500px] w-full px-8 py-4 xl:space-y-2 2xl:space-y-3">
        {/* TERMS CONTENT */}
        ...
        <div className="flex font-[300] w-full gap-[1.5rem]">
          <input
            type="text"
      ...
      <div className="flex items-center gap-[2rem] border-t px-8 py-4">
        ...
        <button
          ...
          className={`px-6 py-4 border-2 border-b-4  border-[#645C4C] rounded-[15px] text-white ${
            isFormComplete
              ? "bg-[#7E7360]"
