...
const TermsServiceModal = ({ isOpen, onClose, onAgree } : any) => {
  ...
  return (
    <ModalBase isOpen={isOpen} onClose={onClose}>
      <div className="flex justify-between w-full bg-inherit items-center mt-[1rem] px-8 xl:py-2 2xl:py-">
      ...
      {/* Scrollable Body */}
      <div className="overflow-y-auto max-h-[450px] xl:max-h-[500px] 2xl:max-h-[620px] w-full px-8 py-4 xl:space-y-2 2xl:space-y-3">
        {/* TERMS CONTENT */}
